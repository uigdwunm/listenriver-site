const translations = {
  zh: {
    ...
    "preview.project": "字幕项目：城市夜景样片",
    "preview.local": "本地",
    "preview.videoCaption": "夜色中的城市沿河展开。",
    "preview.subtitleTracks": "字幕轨道",
    "preview.sourceJapanese": "原文 · 日语",
    "preview.translationChinese": "译文 · 简体中文",
    "preview.translatedText": "夜色中的城市沿河展开。",
    "facts.outputs": "字幕格式",
  ...
  en: {
    ...
    "preview.project": "Subtitle project: City night demo",
    "preview.local": "Local",
    "preview.videoCaption": "The city unfolds along the river at night.",
